namespace Artix.API.Core.ApplicationService.Features.Users.Admin.Commands.Login;
...
internal sealed class LoginQueryHandler : QueryHandlerBase<GetLoginQuery, LoginDto>
{
    ...
    public LoginQueryHandler(IHttpContextAccessor httpContextAccessor, UserManager<AppUser> userManager,
