...
public class AppUser : IdentityUser<long>
{
    ...
    public virtual ICollection<UserJournalEntry> UserJournalEntries { get; private set; } = new List<UserJournalEntry>();
    ...
    public virtual ICollection<UserSeasonProgress> UserSeasonProgresses { get; private set; } = new List<UserSeasonProgress>();
