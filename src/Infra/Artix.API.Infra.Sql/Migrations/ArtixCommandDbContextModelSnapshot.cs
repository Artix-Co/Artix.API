...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Artix.API.Core.Domain.Entities.Museum.Object", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Artix.API.Core.Domain.Entities.Museum.ObjectFile", b =>
                {
            ...
            modelBuilder.Entity("Artix.API.Core.Domain.Entities.Museum.ObjectHistoricalPeriod", b =>
                {
                    b.Property<long>("ObjectId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Artix.API.Core.Domain.Entities.Museum.ObjectType", b =>
                {
            ...
            modelBuilder.Entity("Artix.API.Core.Domain.Entities.Museum.Type", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Artix.API.Core.Domain.Entities.User.OTP", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Artix.API.Core.Domain.Entities.Collection.CollectionItem", b =>
                {
                    ...
                    b.HasOne("Artix.API.Core.Domain.Entities.Museum.Object", "Object")
                        .WithMany()
            ...
            modelBuilder.Entity("Artix.API.Core.Domain.Entities.Museum.ObjectType", b =>
                {
                    ...
                    b.HasOne("Artix.API.Core.Domain.Entities.Museum.Type", "Type")
                        .WithMany("ObjectTypes")
            ...
            modelBuilder.Entity("Artix.API.Core.Domain.Entities.User.UserJournalEntry", b =>
                {
                    b.HasOne("Artix.API.Core.Domain.Entities.JournalEntry.JournalEntry", "Entry")
