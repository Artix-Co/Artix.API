namespace Artix.API.Infra.Sql.Data.Config.Read.Collection;

using Artix.API.Core.Domain.Entities.Collection;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;

internal sealed class CollectionItemReadConfiguration : IEntityTypeConfiguration<CollectionItem>
{
